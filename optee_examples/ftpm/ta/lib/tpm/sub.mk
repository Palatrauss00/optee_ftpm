...
srcs-y += TPMCmd/tpm/src/X509/X509_ECC.c
srcs-y += TPMCmd/tpm/src/X509/X509_RSA.c
srcs-y += TPMCmd/tpm/src/X509/TpmASN1.c
srcs-y += TPMCmd/tpm/src/X509/X509_spt.c
srcs-y += TPMCmd/tpm/src/command/Attestation/CertifyX509.c
...
srcs-y += TPMCmd/tpm/src/command/ClockTimer/ACT_spt.c
srcs-y += TPMCmd/tpm/src/command/ClockTimer/ClockRateAdjust.c
srcs-y += TPMCmd/tpm/src/command/ClockTimer/ACT_SetTimeout.c
...
srcs-y += TPMCmd/tpm/src/crypt/CryptEccCrypt.c
...
srcs-y += TPMCmd/tpm/src/support/TableDrivenMarshal.c
srcs-y += TPMCmd/tpm/src/support/PropertyCap.c
srcs-y += TPMCmd/tpm/src/support/Locality.c
srcs-y += TPMCmd/tpm/src/support/TableMarshalData.c
